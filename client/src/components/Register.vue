        ...
        <div class="col s10" style="margin:4.4%; background-color:rgba(0, 0, 0, 0.5);">
          <form class="col s12">
            ...
            <div class="row">
              ...
              <div class="input-field col s12" style="padding-right:15px;">
                <input id="password" type="password" class="validate" style="color:white;" v-model='userData.password'>
                <label for="password" style="color:white;" >Password</label>
              </div>
              <div class="input-field col s12" style="padding-right:15px;">
                <input id="confirmpassword" type="password" class="validate" style="color:white;" v-model='userData.confirmpassword' v-on:keyup='confirmCheck'>
                <label for="confirmpassword" style="color:white;" >Confirm Password</label>
              </div>
              <label v-if="check == false" style="color:red; padding-left:10px;" @change='confirmCheck'>Please Input correct password !</label>
            </div>
...
export default {
  ...
  methods: {
    ...
    confirmCheck () {
      if (this.password == this.userData.confirmpassword || this.userData.confirmpassword == '') {
        this.check = true
      } else {
        this.check = false
      }
